...
<body>
            ...
            <div class="row">
                <div class="col-md-3 ftco-animate">
                    <div class="project-destination">
                        <a href="#" class="img"
                            style="background-image: url(assets/user/images/place-1.jpg);">
                            <div class="text">
                                <h3>Singapore</h3>
                                <span>8 Tours</span>
                            </div>
                ...
                <div class="col-md-3 ftco-animate">
                    <div class="project-destination">
                        <a href="#" class="img"
                            style="background-image: url(assets/user/images/place-2.jpg);">
                            <div class="text">
                                <h3>Canada</h3>
                                <span>2 Tours</span>
                            </div>
                ...
                <div class="col-md-3 ftco-animate">
                    <div class="project-destination">
                        <a href="#" class="img"
                            style="background-image: url(assets/user/images/place-3.jpg);">
                            <div class="text">
                                <h3>Thailand</h3>
                                <span>5 Tours</span>
                            </div>
                ...
                <div class="col-md-3 ftco-animate">
                    <div class="project-destination">
                        <a href="#" class="img"
                            style="background-image: url(assets/user/images/place-4.jpg);">
                            <div class="text">
                                <h3>Autralia</h3>
                                <span>5 Tours</span>
                            </div>
    ...
    <section class="ftco-section testimony-section bg-bottom"
        style="background-image: url(assets/user/images/bg_3.jpg);">
        <div class="container">
            <div class="row justify-content-center pb-4">
