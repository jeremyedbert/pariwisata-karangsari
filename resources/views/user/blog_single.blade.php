        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 order-md-last ftco-animate py-md-5 mt-md-5">
                    ...
                    <p>
                        <img src="assets/user/images/image_6.jpg" alt="" class="img-fluid">
                    </p>
                    ...
                    <p>
                        <img src="assets/user/images/image_4.jpg" alt="" class="img-fluid">
                    </p>
                    ...
                    <div class="about-author d-flex p-4 bg-light">
                        <div class="bio mr-5">
                            <img src="assets/user/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
                        </div>
                        <div class="desc">
                    ...
                    <div class="pt-5 mt-5">
                        ...
                        <ul class="comment-list">
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="assets/user/images/person_1.jpg" alt="Image placeholder">
                                </div>
                ...
                <div class="col-lg-4 sidebar ftco-animate bg-light py-md-5">
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="blog-img mr-4" style="background-image: url(assets/user/images/image_3.jpg);"></a>
                            <div class="text">
                                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about
                                        the blind texts</a></h3>
                                <div class="meta">
